    ...
    subModules: [
      {
        ...
        features: [
          ...
          { label: "Banco de dados real com tabelas completas (Supabase)", status: "andamento" },
          { label: "Leitura de dados reais substituindo dados de demonstração", status: "andamento" },
