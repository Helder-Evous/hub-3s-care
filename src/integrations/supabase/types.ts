...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ai_tasks: {
        Row: {
          ...
          payload: Json | null
          priority: Database["public"]["Enums"]["ai_task_priority"]
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_tasks_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_tasks_onboarding_id_fkey"
          ...
          {
            foreignKeyName: "ai_tasks_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "hub_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_tasks_sale_id_fkey"
            columns: ["sale_id"]
            isOneToOne: false
    ...
    Enums: {
      ai_task_priority: "baixa" | "media" | "alta" | "critica"
      ai_task_status:
        | "pendente"
        | "em_revisao"
        | "aprovada"
